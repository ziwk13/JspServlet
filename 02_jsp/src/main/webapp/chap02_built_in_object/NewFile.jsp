...
<body>
  ...
  1. 웹 애플리케이션 개발을 쉽게 할 수 있도록 미리 생성 해서 제공하는 객체
  2. JSP에서는 별도의 선언 없이 곧바로 내장 객체를 사용 할 수 있다.
  3. 주요 내장 객체
  ...
  4. 주요 객체 주의사항
     1) config    : JSP 페이지 초기화 파라미터 등에 접근 할 때 사용 할 수 있으나, 일반적으로 거의 사용 안 함
     2) page      : JSP가 서블릿으로 변환 되었을 때 현재 서블릿 인스턴스 자신을 의미하나, 거의 사용 안 함(this와 동일 하기 때문에)
